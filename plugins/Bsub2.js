        ...
        conn.ev.on('messages.upsert', async (messageUpdate) => {
            ...
            if (isReplyToSentMsg) {
                ...
                if (!isNaN(selectedNumber) && selectedNumber > 0 && selectedNumber <= episodes.length) {
                    ...
                    // Send the image of the selected episode
                    await conn.sendMessage(from, { image: { url: selectedEpisode.imgUrl }, caption: `🎬 *${selectedEpisode.title}*\n🔗 Link: ${selectedEpisode.episodeLink}` }, { quoted: mek });
                } else {
